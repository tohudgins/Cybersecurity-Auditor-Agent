...
COMPLIANCE_QA_PROMPT = PromptTemplate(
    input_variables=["context", "question", "history", "crosswalk"],
    template=(
        ...
        "OWASP, MITRE ATT&CK, PCI DSS, HIPAA, SOC 2, CMMC, ...). Each excerpt is prefixed with its "
        "source in brackets like [Framework Name, p.N].\n\n"
